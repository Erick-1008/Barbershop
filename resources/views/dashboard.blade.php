            ...
            <div class="col-lg-4">
                <div class="card bg-light shadow-lg">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Convertirnos en la solución tecnológica más confiable y ampliamente utilizada en el sector de barberías, promoviendo la transformación digital del negocio tradicional hacia un modelo moderno, eficiente y orientado al cliente, con innovación constante y excelencia en cada detalle.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-light shadow-lg">
                    <div class="card-body">
                        ...
                        <p class="card-text fw-bold">
                            "System Barber Shop: Innovación que transforma tu barbería."
                        </p>
                    </div>
                </div>
            </div>
