...
return [
    ...
    */
    ...
    'logo' => '<b>SYSTEM</b>BARBERSHOP',
    'logo_img' => 'vendor/adminlte/dist/img/LOGO.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Admin Logo',
    'logo_url' => 'SYSTEM BARBERSHOP',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Reservaciones',
            'url' => 'http://127.0.0.1:8000/reservaciones',
            'icon' => 'far fa-fw fa-file',
            'label_color' => 'success',
        ],

        [
            'text' => 'VistaReservaciones',
            'url' => 'http://127.0.0.1:8000/vistareservaciones',
            'icon' => 'far fa-fw fa-file',
            'label_color' => 'success',
        ],
    ...
    'plugins' => [
        ...
        'files' => [
            [
                'type' => 'js',
                'asset' => false,
                'location' => '//cdn.datatables.net/2.1.3/js/dataTables.min.js',
            ],
            [
                'type' => 'css',
                'asset' => false,
                'location' => '//cdn.datatables.net/2.1.3/css/dataTables.dataTables.min.css',
            ],
        ],
    ],
    'Modal' => [
